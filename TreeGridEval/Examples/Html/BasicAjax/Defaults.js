...
Cfg: {
   ...
   PrintCols:"2", PrintRows:"50", PrintFiltered:"0", PrintExpanded:"0", PrintIcons:"1", PrintPrint:"1", PrintGanttSplit:"1", PrintGanttSplitMin:"100", PrintGanttBackground:"1", PrintVarHeight:"1", PrintPageRootMin:"10", PrintZoomFit:"1", PrintSplitRowSpan:"1",
   ...
   Language:"", SyncLanguage:"1", UseLanguages:"EN,GB,DE,FR,CA,IT,ES,PT,BR,CS,RU,JP,FA",
   ...
   IESvg:"CustScroll1Right,CustScroll1Left,CustScroll1Down,CustScroll1Up,LevelButton,SpaceSelectInner,ButtonClose,PopupLeft,TabHtmlBase PopupLeft,PanelMove,PanelSelect,PanelSelectOn,PanelDelete,PanelCopy,CellHeaderPanel PanelSelect,CellHeaderPanel PanelSelectOn,CellHeaderPanel PanelCopy,FastPanel,Width1,Width2,Width3,Width4,Width1T,Width2T,Width3T,Width4T,1E,1C,TreeRev 1E,TreeRev 1C,E,C,TreeRev E,TreeRev C,D0,D1,D2,D3,D4,NE,Rtl NE,NC,NTreeRev.NC,ND0,ND0R,ND1,ND1R,ND2,ND2R,ND3,ND3R,ND4,ND4R,DateLeft,DefaultsLeft,EnumLeft,ExpandLeft,HeaderRow ExpandLeft,CollapseLeft,HeaderRow CollapseLeft,FileLeft,ClearLeft,EnumHeaderLeft,Check0Left,Check1Left,Check2Left,Filter0,Filter1,Radio0Left,Radio1Left,Radio2Left,Radio3Left,Bool0,Bool1,BoolX,Bool2,Bool3,Bool0Space,Bool1Space,BoolXSpace,Bool2Space,Bool3Space,Filter0Left,Filter1Left,Filter2Left,Filter3Left,Filter4Left,Filter5Left,Filter6Left,Filter7Left,Filter8Left,Filter9Left,Filter10Left,Filter11Left,Filter12Left,Sort0Left,Sort1Left,Sort2Left,Sort3Left,Sort4Left,Sort5Left,Sort6Left,DragColInsideTop,DragColOutsideTop,DragColInsideBottom,DragColOutsideBottom,DragRowLeft,DragRowRight,MenuItemBorder,MenuItemBorderAll,MenuItemBorderO15,MenuItemBorderI3,MenuItemBorderI2,MenuItemBorderI1,MenuItemBorderO1,MenuItemBorderO2,MenuItemBorderO4,MenuItemBorderO8,MenuItemBorderO5,MenuItemBorderO10,MenuClose,MenuCheckedIconLeft,MenuUncheckedIconLeft,MenuCheckedRadioLeft,MenuUncheckedRadioLeft,MenuExpandedIcon,MenuCollapsedIcon,MenuNextIcon,TSMenuNextIconRtl,MenuNextIconDown,MenuEnum,MenuEnumHeaderLeft,EnumControl,PickMYDown,PickMYUp,PickBL,PickBR,PickEmpty,Pick2BL,Pick2BR,ChartPoint1,ChartPoint2,ChartPoint3,ChartPoint4,ChartPoint5,ChartPoint6,ChartPoint7,ChartPoint8",
   IESvgTool:"Save,Reload,Repaint,Repaint1,Print,ExportPDF,Export,Import,Undo,Redo,Add,AddChild,AddCol,Join,Split,Outdent,Indent,Sort,Calc,ExpandAll,CollapseAll,Columns,Cfg,Help,Debug,ResizeGrid,ResizeGridRtl,PagerFirst,PagerNext,PagerPrev,PagerLast,Correct,Correct1,ZoomIn,ZoomOut,ZoomFit,Left,Left1,Center,Center1,Right,Right1,Top,Top1,Middle,Middle,Bottom,Bottom1,Bold,Bold1,Italic,Italic1,Underline,Underline1,Strike,Strike1,RotateLeft,RotateLeft1,RotateRight,RotateRight1,WrapText,WrapText1,ColorText,ColorBackground,ColorShadow,Border,BorderAll,BorderO15,BorderI3,BorderI2,BorderI1,BorderO1,BorderO2,BorderO4,BorderO8,BorderO5,BorderO10",
   IESvgGantt:"DepArrow00LeftHover,DepArrow10LeftHover,DepArrow20LeftHover,DepArrow30LeftHover,DepArrow00RightHover,DepArrow10RightHover,DepArrow20RightHover,DepArrow30RightHover,NbspOut,JoinLeft div,JoinLeft.JoinRight div,JoinLeftNbsp div,JoinLeftNbsp.JoinRightNbsp div,JoinLeft.JoinRightNbsp div,JoinLeftNbsp.JoinRight div,RedIn0Crit,RedIn0Err,LockedIn,LockedIn CompleteGauge,InDisabled,OutLeft,OutRight,InLeft,InRight,ManualStart,ManualEnd,Flag,FlagHover,DragPointer,Point1Hover,Point2,Point3,Point4,Point5,Point6,Point7,Point8,MinStart,MaxStart,MinEnd,MaxEnd,MinStartHover,MaxStartHover,MinEndHover,MaxEndHover",
   ...
   IESvgGanttMilestone:"*,Sel*,*Hover,Sel*Hover,Run*,RunSel*,Run*Hover,RunSel*Hover,*Error,Sel*Error,*ErrorHover,Sel*ErrorHover,*0,Sel*0,*0Hover,Sel*0Hover,*100,Sel*100,*100Hover,Sel*100Hover,*0Crit,Sel*0Crit,*0CritHover,Sel*0CritHover,*0Err,Sel*0Err,*0ErrHover,Sel*0ErrHover,Stop*,StopSel*,Stop*Hover,StopSel*Hover,*Disabled,Sel*Disabled,*DisabledHover,Sel*DisabledHover,Group*,GroupSel*,Group*Hover,GroupSel*Hover,Group*0,GroupSel*0,Group*0Hover,GroupSel*0Hover,Group*0Crit,GroupSel*0Crit,Group*0CritHover,GroupSel*0CritHover,Group*0Err,GroupSel*0Err,Group*0ErrHover,GroupSel*0ErrHover,Black*,Red*,Blue*,Green*,Fuchsia*,Yellow*,Aqua*,Silver*,Orange*,Lime*,BlackSel*,RedSel*,BlueSel*,GreenSel*,FuchsiaSel*,YellowSel*,AquaSel*,SilverSel*,OrangeSel*,LimeSel*"
   },
...
Actions: {
   ...
   OnClickNothing:"CloseDialog", OnClickOther:"CloseDialog",
   ...
   OnClickButtonExpandAll:"ExpandAllF",
   OnClickButtonCollapseAll:"CollapseAllF",
...
Def: {
   ...
   Fixed: { 
      Def:"R", CanDelete:"0", CanSelect:"0", CanDrag:"0", CanFilter:"0", CanCopy:"0", AcceptChild:"0", CanHide:"1"
      },

   // Default row for filter rows
   Filter: { 
      Def:"Fixed", FormulaCanUse:"0", FormulaCanEdit:"0", CanHide:"1"
      },

   // Default row for column panel rows
   Panel: { 
      Def:"Fixed", Buttons:"ColSelect,ColDelete,ColCopy", CanFocus:"0", NoBorder:"3", NoStyle:"2", NoFormat:"2", CanPrint:"0", CanExport:"0", CanHide:"1",
      PanelColCopyMenu:"CopyCol,CopyCols@FC,CopySelectedCols@SC,-,AddCol,AddCols@2,AddSelectedCols@2",
      PanelColCopyAllMenu:"CopyCol,CopyCols@2,CopySelectedCols,-,AddCol,AddCols@2,AddSelectedCols@2,-,AddColEnd"
      },

   // Default row created when grouping
   Group: { 
      Def:"R", Group:"1", CanEdit:"0", CanFilter:"0", CanDrag:"0", CanCopy:"0", CanDelete:"0",
   ...
   SPage: { Def:"", Expanded:"3", CanExpand:"3", Visible:"0", AggChildren:"1" }
...
DefCols : {
   ...
   Index: { 
      Def:"C", Type:"Text", HoverCell:"Color", Width:"60", CanSort:"0", CanEdit:"0", CanFocus:"0", CanSelect:"0", CanDelete:"0", CanMove:"0", CanCopy:"0", CanCopyPaste:"0", CanEmpty:"1", CanSearch:"0", CanSearch:"0", FormulaCanUse:"0", NoIndex:"1", NoBorder:"3", NoStyle:"2", NoFormat:"2"
      },

   // Auto generated column for ConstWidth
   ConstWidth: { 
      Def:"", CanSelect:"0", Type:"Html", ConstWidth:"1", NoIndex:"1", NoBorder:"3", NoStyle:"2", NoFormat:"2", WidthPad:"0"
      },

   // Default column for type Gantt
   Gantt: { 
      Def:"C", MenuName:"Gantt chart", CanSort:"0", CanEdit:"0", CanResize:"0", CanFilter:"0", CanCopyPaste:"0", CanGroup:"0", CanSearch:"0", CanExport:"0", WidthPad:"", ShowHint:"0", CanDrag:"0", CanSelect:"0", CanDelete:"0", NoUpload:"1", FormulaCanUse:"0",
...
Header: { 
   Kind:"Header",Def:"Header", id:"Header", CanDrag:"0", CanCopy:"1", CanSelect:"1", CanDelete:"1", CanExport:"1"
   },
...
Panel : {
   ...
   CanHide:"1", CanResize:"0", CanMove:"0", CanDrag:"1", CanExport:"0", CanCopyPaste:"0", CanSelect:"0", CanPrint:"0", NoUpload:"1", FormulaCanUse:"0", NoBorder:"3", NoStyle:"2", NoFormat:"2",
	HoverCell:"Color",
   PanelCopyMenu:"CopyRow,CopyRows@F,CopyTree,CopyRowsTree@F,CopySelected@S,CopySelectedTree@S,CopySelectedChildEnd,CopySelectedTreeChildEnd,-,AddRow,AddRows@2,CopyEmpty,CopyRowsEmpty,CopySelectedEmpty,-,AddChildEnd,CopySelectedEmptyChildEnd",
...
Toolbar: { 
   ...
   AddButton:"Class", AddOnEnter:"ShowMenuF OR AddRowF OR AddRowEndF", AddVisibleFormula:"Grid.Adding",
...
// Configuration menus
MenuCfg : {
	Items:"GanttCaption,GanttCfg,CfgCaption,Cfg,StylesCaption,Styles,LanguageCaption,Language", Attribute:"CanHide", HideUnused:"1"
	},
MenuColumns : {
...
Languages: {
   EN: { Name:"English", Text_Jsonp:"Text.js" },
   DE: { Name:"Deutsch", Text_Url:"Languages/TextDE.xml" },
   NL: { Name:"Nederlands", Text_Url:"Languages/TextNL.xml" },
   FR: { Name:"Fran&#xE7;ais", Text_Url:"Languages/TextFR.xml" },
   IT: { Name:"Italiano", Text_Url:"Languages/TextIT.xml" },
   ES: { Name:"Espa&#xF1;ol", Text_Url:"Languages/TextES.xml" },
   PT: { Name:"Portugu&#xEA;s", Text_Url:"Languages/TextPT.xml" },
   BR: { Name:"Portugu&#xEA;s", Text_Url:"Languages/TextBR.xml" },
   CS: { Name:"&#x10c;esky", Text_Url:"Languages/TextCS.xml" },
   RU: { Name:"&#1055;&#1086;-&#1088;&#1091;&#1089;&#1089;&#1082;&#1080;", Text_Url:"Languages/TextRU.xml" },
   KR: { Name:"&#xd55c;&#xad6d;&#xc5b4;", Text_Url:"Languages/TextKR.xml" },
   JP: { Name:"&#x65e5;&#x672c;&#x8a9e;", Text_Url:"Languages/TextJP.xml" },
   CN: { Name:"&#x4e2d;&#x6587;", Text_Url:"Languages/TextCN.xml" },
   FA: { Name:"&#x641;&#x627;&#x631;&#x633;&#x6CC;", Text_Url:"Languages/TextFA.xml" },
   XX: { Name:"XX Test", Text_Url:"Languages/TextXX.xml" }
   },

// Format configuration the same for all languages
Lang: {
   Format: {
      StrictNumbers:"0", StrictDates:"15", GMT:"1", DateFormatLowercase:"1", EditFormats:"", ExactNumbers:"0",
