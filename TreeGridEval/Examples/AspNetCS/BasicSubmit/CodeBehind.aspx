...
<html xmlns="http://www.w3.org/1999/xhtml" >
   ...
   <body>
      ...
      <center class="ExampleShort">Uses code excluded to .cs file by @Page Src attribute, uses <b>&lt;form> submit</b> and .NET <b>DataTable</b> class and <b>DbDataAdapter</b> interface</center>
      <div class="ExampleDesc">
         <i>Source files:</i> <h4>CodeBehind.aspx</h4> (this html page and also includes CodeBehind.aspx.cs script), <a href="DBDef.xml" target="_blank"><h4>DBDef.xml</h4></a> (static XML layout), 
         <h4>CodeBehind.aspx.cs</h4>(included server script generates and processes XML data), <h4>../Database.db</h4> (source SQL database, table <b>TableData</b>)
      </div>
      <div class="ExampleDesc">
    ...
    <form runat="server" method="post" class="ExampleForm">
      ...
      <script>
         var TGTrial = document.cookie.match(/TGTrialCS\s*=\s*(\d+)/), TGIndex = 2048;
         if(!TGTrial||!(TGTrial[1]&TGIndex)) setTimeout(function(){
            var n = "RunTrialCSCodeBehindSubmit", d = (new Date((new Date).getTime()+31536000000)).toUTCString(); document.cookie = "TGTrialCS="+((TGTrial?TGTrial[1]:0)|TGIndex)+";expires="+d;
