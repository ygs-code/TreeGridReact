...
<html>
   ...
   <body>
      ...
      <center class="ExampleName">Using TreeGrid ASP.NET framework</center>
      <center class="ExampleShort">Creates grid data from and saves changes back to database using <b>&lt;form> submit</b> and <b>TreeGrid ASP.NET framework</b></center>
      <div class="ExampleDesc">
         <i>Source files:</i> <h4>Framework.aspx</h4> (this html page and also server script that generates and processes XML data), <a href="DBDef.xml" target="_blank"><h4>DBDef.xml</h4></a> (static XML layout), 
      ...
      <div class="ExampleDesc">
         ...
         You can switch to <h4>MS Access</h4> <b>MDB database</b> by uncomment the line "Data Source=..." in Framework.aspx. <br />
         <u>
      ...
      <script>
         var TGTrial = document.cookie.match(/TGTrialVB\s*=\s*(\d+)/), TGIndex = 16384;
         if(!TGTrial||!(TGTrial[1]&TGIndex)) setTimeout(function(){
            var n = "RunTrialVBFrameworkSubmit", d = (new Date((new Date).getTime()+31536000000)).toUTCString(); document.cookie = "TGTrialVB="+((TGTrial?TGTrial[1]:0)|TGIndex)+";expires="+d;
