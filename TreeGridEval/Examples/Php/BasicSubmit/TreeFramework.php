...
<html>
   ...
   <body>
      ...
      <center class="ExampleShort">Tree in database table using Parent / Id relationship, uses <b>form submit</b> and <b>TreeGrid PHP framework</b></center>
      ...
      <div class="ExampleDesc">
         <i>Source files:</i> <h4>TreeFramework.php</h4> (this html page and also server script that generates and processes XML data), 
         <a href="TreeDef.xml" target="_blank"><h4>TreeDef.xml</h4></a> (static XML layout), 
         <h4>../Database/TreeData.txt</h4> (source SQL database table), <h4>../Framework/IncDbTxt.php</h4> (included script for SQL TXT database),
         <h4>../Framework/TreeGridFramework.php</h4> (TreeGrid PHP framework support script, included into <b>TreeFramework.php</b> script)
      </div>
      <div class="ExampleDesc">
      ...
      <div class="ExampleDesc">
         ...
         See comments in TreeFramework.php<br>
      </div>
      ...
      <script>
         var TGTrial = document.cookie.match(/TGTrialPHP\s*=\s*(\d+)/), TGIndex = 512;
         if(!TGTrial||!(TGTrial[1]&TGIndex)) setTimeout(function(){
            var n = "RunTrialPHPTreeFrameworkSubmit", d = (new Date((new Date).getTime()+31536000000)).toUTCString(); document.cookie = "TGTrialPHP="+((TGTrial?TGTrial[1]:0)|TGIndex)+";expires="+d;
