...
var ext = {'htm':3,'html':3,'xml':2,'gif':1,'jpg':1,'png':1,'txt':3,'js':2,'css':2}[(Get(row,"E")+'').toLowerCase()]; // 1 view, 2 edit, 3 view+edit
...
if(row.Def.Group){ // Directory
   ...
   if(row.Panel.indexOf("Show")>=0) I[p++] = { Name:"View the file",OnClick:function(){ DisplayFile(row); } }
   }
I[p++] = "-";
