...
?>
<Grid>
   <Cfg id='ResourceGrid' MainCol='Project' MaxHeight='1' MinTagHeight="400" ShowDeleted="0" DateStrings='1' 
      IdNames='Project' AppendId='1' FullId='1' IdChars='0123456789' NumberId='1' LastId='1' CaseSensitiveId='1'/>
   <LeftCols>
      <C Name='id' CanEdit='0'/>
      <C Name='Project' Width='200' Type='Text'/>
   </LeftCols>
   <Cols><?php echo $Cols;?>
   </Cols>
   <RightCols>
      <C Name='Sum' Width='60' Type='Float' Formula='<?php echo $CSum;?>' Format='0.##'/>
   </RightCols>
   <Def>
