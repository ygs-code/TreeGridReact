 ...
 * @LastEditors:
 * @LastEditTime: 2019-08-26 18:21:40
 */
{
Cfg : {
...
Def: {
   ...
   GroupPartner : {
      Def:'Group',
      GroupCol:'P',
      GroupCols:'|P|R,P|C,P|S,P|R,C,P|R,S,P|C,S,P|R,C,S,P',
      GroupMain:'M',
      GroupMainCaption:'Partner / Month',
      EditCols:'Main,R,C,S,X,N,A,B', CanDelete:'1', CanDrag:'1',
      OnGroup:'Grid.Adding=1;',
      P:'New partner',
      M:'New partner',
      MType:'Text',
      ParentAcceptDef:'GroupPartner',
      AcceptDef:'R',
      Items: [
         { M:'0' },
         { M:'1' },
   ...
   GroupLocPartner: {
         ...
         GroupCols:'|P|R,P|C,P|S,P|R,C,P|R,S,P|C,S,P|R,C,S,P|',
         GroupMain:'M',
         GroupMainCaption:'Location / Partner / Month',
         EditCols:'Main',
         RCopyTo:'Children,R',
         CCopyTo:'Children,C',
         SCopyTo:'Children,S',
   ...
   GroupLoc: {
         Def:'GroupLocPartner',
         GroupCol:'R,C,S',
         GroupCols:'|R|C|S|R,C|R,S|C,S|R,C,S',
         GroupMain:'P',
         GroupMainCaption:'Location / Partner',
         MVisible:'0'
      },
...
Cols: [ // 数据字段设置
   ...
   { Name:'I', Width:'90', Type:'Int', Format:',0.00' }, // Income
