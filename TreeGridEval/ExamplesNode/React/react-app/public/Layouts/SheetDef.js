 ...
 * @version:
 * @Author:
 * @Date: 2019-05-09 00:17:36
 * @LastEditors:
 * @LastEditTime: 2019-08-26 17:25:40
 */
{
Cfg: { CfgId:"Sheet", SuppressCfg:"1", Sorting:"0",// Suppresses configuration and sorting  抑制配置和排序
   SuppressMessage:"3",                         // Suppresses all messages, including page messages  禁止所有消息，包括页面消息
