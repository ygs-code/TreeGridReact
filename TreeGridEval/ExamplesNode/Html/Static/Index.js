...
// Creates simple global component
function TTG(){ 

// Links the TTG component with the created TreeGrid. The TTG component will be accessible in grid events as Grid.Component and grid will be accessible from TTG code as this.Grid
...
var Component = this;
Grids.OnInit = function(grid){ grid.Component = Component; Component.Grid = grid; }
...
var TG = new TTG(); // Creates new global instance of the TTG object, to be used in the onclick of the example links
...
// object item: clicked DOM element
TTG.prototype.Reload  = function(example,item) {
...
// Custom method to demonstrate calling the TTG method from TreeGrid code
...
TTG.prototype.showCustomMenu = function(row,col) {
var G = this.Grid;
