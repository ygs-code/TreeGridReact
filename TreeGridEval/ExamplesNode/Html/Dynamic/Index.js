...
// Links the TTG component to the created grid as Grid.Component and the grid to TTG component by the this.Grid
this.Grid = TreeGrid(
   { 
...
// Creates the TreeGrid dynamically on window load, after the main tag is created
var TG = null;
window.onload = function(){ 
TG = new TTG(); // Creates new global instance of the TTG object, to be used in the onclick of the example links
}
