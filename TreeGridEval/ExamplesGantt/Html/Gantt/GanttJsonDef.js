...
Cfg: {
   ...
   CopyPasteTree:"2",                  // When copying and pasting grouping row, it copies and pastes also all its visible children
   ...
   CalendarsRepeatType:"Enum", CalendarsRepeatEnum:"||Weekly|Daily", CalendarsRepeatEnumKeys:"||w|d", CalendarsRepeatWidth:"80",  // Settings for Calendar list dialog, the Repeat column 
   CalendarsValueType:"Enum", CalendarsValueEnum:"|Not work|Exception|Lunch|Weekend|Holiday|Reserved1|Reserved2", CalendarsValueEnumKeys:"||0|1|2|3|4|5", CalendarsValueCaption:"Type", CalendarsValueWidth:"70", // Settings for Calendar list dialog, the Value column 
   CalendarsStartDefaultDate:"3/1/2018", CalendarsEndDefaultDate:"3/1/2018", // Default dates for Start and End columns in Calendar list dialog
   PrintPagePrefix:"<center class='%9' style='width:%7px'>Gantt example printed page %3 from %6</center>", // Sample page header for printing
...
Actions: {
   ...
   OnRightClickGanttHeader:"UndoZoom,1",   // Sets only zoom undo to the right click Gantt header, removes the zoom out action
   OnClick1GanttHeader:"GanttMenu",        // On tablet shows the zoom menu on click to header instead of direct zooming 
   OnCtrlC:"Copy,ClearSelection,0"         // Clears the selection of rows when copied to clipboard
   },
Def: {
   R: { CDef:"",                           // The standard rows cannot have children 
      CALENDARCanPaste:"2" },              // Permits pasting to CALENDAR column although it is not editable
   // Group row shows summary of the main bars 
   Sum: { 
      Group:"1", NoUpload:"1",  // By default can be used for grouping, changed by JavaScript code when clicking to "Network diagram", tab 
      ...
      AcceptDef:"R", // Grouping rows can get standard rows as children -->
      ParentCDef:"Sum", // When grouped by any column, new rows added to root will be of these groups -->
      ParentAcceptDef:"Sum", // It is possible to move and copy group rows to the root between other groups -->
      ...
      CanFilter:"2",    // Does not filter the groups, hides them only if no child is visible
   ...
   SumTask: { GroupCols:"|TASK|COMPLETE,TASK", Def:"Sum", GroupMain:"SECTION", ParentCDef:"SumTask", ParentAcceptDef:"SumTask" },  // When grouping by Task, shows tree in Section column 

   // Network diagram row shows summary of the first main bar plan as run bars with dependencies 
   Diagram: { Def:"Group", Group:"0",        // By default cannot be used for grouping, changed by JavaScript code when clicking to "Network diagram", tab 
...
Lang: {
   // External date format definitions for easy translation
   Format : {
      d:"[y!=2018]yyyy MMM dd, '<i>'HH'</i>';MMM dd, '<i>'HH'</i>'", dh:"ddd M/d/yyyy, '<i>'HH'</i>'", df:", 0.## hours;;, delete",
      d1:"dddd dddddd MMMM yyyy", h1:"HH 'hour'", m1:"' minute'", m2:"' half minute'", m3:"' quarter minute'", hhh:"hhh 'hours'", dtp:"MMMMMMM dd, '<i>'HH'</i>'",


      // Colors the separators to be better visible, there must be also set Cfg NoFormatEscape for it
      ValueSeparatorHtml:"<em>; </em>", RangeSeparatorHtml:"<em> ~ </em>"
      },
   },
// Shared definition for more columns
DefCols: {
   C: { CaseSensitive:"0" },  // Ignores case when it sorts, groups and filters
   Date: { Type:"Date", Format:"d" }, // Default date column, defines the date format without year for year 2018 and with year for other years
   },

// Columns definition
LeftCols: [
   { Name:"id", Type:"Int", Width:"40", CanEdit:"0" },  // id / row number column 
   { Name:"TASK", Width:"54", Type:"Text", GroupWidth:"1" },  // Task name column 
   { Name:"SECTION", Width:"50", GroupWidth:"1", Type:"Text", MenuName:"Task section" },  // Section name column 
   ],
Cols: [
   { Name:"START", Width:"106", Def:"Date", DefaultDate:"3/1/2018 9:00" } ,  // First main bar Start date column 
   { Name:"END", Width:"106", Def:"Date", DefaultDate:"3/1/2018 18:00", CanEmpty:"1" },  // First main bar End date column 
   ...
   { Name:"START1", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 9:00" } ,  // Second main bar Start date column 
   { Name:"END1", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 18:00", CanEmpty:"1" },  // Second main bar End date column 
   { Name:"DURATION1", Visible:"0", Width:"33", Type:"Text", Align:"Right", MenuName:"Duration" },  // Second main bar Duration column 
   { Name:"PARTS1", Visible:"0", Width:"180", Def:"Date", DefaultDate:"3/1/2018 9:00~3/1/2018 18:00", Range:"1", Button:"" },  // Second main bar Parts column for discrete bar 
   ...
   { Name:"FLAGS", Visible:"0", Width:"90", Def:"Date", DefaultDate:"3/1/2018 9:00", Range:"1", Button:"" },  // Flags column 
   ...
   { Name:"MINSTART", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 9:00" },  // Min Start date column 
   { Name:"MAXSTART", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 9:00" },  // Max Start date column 
   { Name:"MINEND", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 18:00" },  // Min End date column 
   { Name:"MAXEND", Visible:"0", Width:"106", Def:"Date", DefaultDate:"3/1/2018 18:00" }  // Max End date column 
...
Header: { MenuName:"Header",
   ...
   SECTION:"Task<br>Section", SECTIONTip:"Name of individual task part, any custom string<br>When grouped, it shows task name in parent and the section name in child row",
   ...
   CALENDAR:"Calendar", CALENDARTip:"Custom calendar for all task plans and other Gantt objects.<br>Defines excluded dates ignored in Gantt calculations",
...
Head: [
   { Kind:"Filter", id:"Filter", idType:"Text", idVisible:"0", SECTIONTip:"Filters only subtasks", CALENDARType:"Html" }    //  Adds filter row
   ],
...
RightCols: [
   ...
   GanttLines:"3#3/27/2018#Navy2;5#3/23/2018 18:00#Hidden",  // Defines two vertical lines, one for simulated actual date and one hidden to change progress line 
   ...
   GanttBase:"3/14/2018 9:00",  // Project start date, all the tasks should start after this date 
   ...
   GanttDependencyTip:"From: <b>*From*</b>, *Start*<br>To: <b>*To*</b>, *End*<br>Type: <b>*Type*</b><br>Lag: <b>*Lag*</b><br>Float: <b>*Float*</b>", GanttDependencyTipDateFormat:"dtp*",  // Specifies tooltip shown for dependency line 
   GanttDragTip:"31", GanttDragTipDateFormat:"MMMM dd, '<i>'HH'</i>'", GanttDragTipDurationFormat:"df*",  // Tooltip shown during dragging 
   ...
   GanttChartMinStart:"1/1/2015", GanttChartMaxEnd:"1/1/2026",
   ...
   GanttZoomUndo:"2" //  Permits zoom undo also for standard zoom in, out and change
...
Zoom: [
   ...
   { Name:"years and halves",       GanttUnits:"M6", GanttChartRound:"y", GanttWidth:"22", GanttWidthEx:"92.4", GanttPrintRound:"y", GanttBackground:";y#1/1/2018",
                                    GanttHeader1:"y#yyyy", GanttHeaderStyle1:"4", GanttHeader3:"M6#MMMMMM" },
   { Name:"years and quarters",     GanttUnits:"M3", GanttChartRound:"y", GanttWidth:"30", GanttWidthEx:"126", GanttPrintRound:"y", GanttBackground:";y#1/1/2018",
                                    GanttHeader1:"y#yyyy", GanttHeader3:"M3#MMMMM" },
   { Name:"halves and months",      GanttUnits:"M", GanttChartRound:"y", GanttWidth:"25", GanttWidthEx:"105", GanttPrintRound:"M6", GanttBackground:";M6#1/1/2018",
                                    GanttHeader1:"M6#MMMMMM. yyyy", GanttHeader3:"M#MM" },
   { Name:"quarters and months",    GanttUnits:"M", GanttChartRound:"M6", GanttWidth:"35", GanttWidthEx:"147", GanttPrintRound:"M3", GanttBackground:";M3#1/1/2018",
                                    GanttHeader1:"M3#MMMMM. yyyy", GanttHeader2:"M#MMM" },
   { Name:"months and weeks",       GanttUnits:"d", GanttChartRound:"M", GanttWidth:"4", GanttWidthEx:"16.8",  GanttPrintRound:"M", GanttBackground:";M#1/1/2018",
   ...
   { Name:"days and hours",         GanttUnits:"h", GanttChartRound:"d", GanttWidth:"12", GanttWidthEx:"36", GanttPrintRound:"d",
                                    GanttHeader1:"d#d1*", GanttHeader5:"h#HHHH'<br>'HHHHH" },
   ...
   { Name:"hours and quarters",     GanttUnits:"h", GanttChartRound:"d", GanttWidth:"90", GanttPrintRound:"h3", GanttBackground:"w#1/6/2018~1/8/2018; h#00:00",
                                    GanttHeader1:"h3#d1*", GanttHeader2:"h#h1*", GanttHeader3:"m15#mm",
   ...
   { Name:"hours and 5 minutes",    GanttUnits:"m5", GanttChartRound:"h", GanttWidth:"25", GanttPrintRound:"h", GanttBackground:"w#1/6/2018~1/8/2018; h#00:00",
                                    GanttHeader1:"h#d1*", GanttHeader2:"h#h1*", GanttHeader3:"m5#mm",
   ...
   { Name:"hours and minutes",      GanttUnits:"m", GanttChartRound:"h", GanttWidth:"10", GanttPrintRound:"h", GanttBackground:"m15#00:00; h#00:00",
                                    GanttHeader1:"h#d1*, '<b>'*h1*'</b>'", GanttHeader5:"m#mmmm'<br/>'mmmmm",
   ...
   { Name:"halves and minutes",     GanttUnits:"m", GanttChartRound:"h", GanttWidth:"15", GanttPrintRound:"m30", GanttBackground:"m15#00:00; h#00:00",
                                    GanttHeader1:"m30#d1*, '<b>'HH:mm '</b>'", GanttHeader5:"m#mmmm'<br>'mmmmm",
   ...
   { Name:"quarters and minutes",   GanttUnits:"m", GanttChartRound:"h", GanttWidth:"25", GanttPrintRound:"m15", GanttBackground:"m15#00:00; h#00:00",
                                    GanttHeader1:"m15#d1*, '<b>'HH:mm '</b>'", GanttHeader3:'m#mm',
   ...
   { Name:"minutes and 5 seconds",  GanttUnits:"s5", GanttChartRound:"m15", GanttWidth:"22", GanttPrintRound:"m", GanttBackground:"m#00:00; h#00:00",
                                    GanttHeader1:"m#d1*", GanttHeaderStyle1:"2", GanttHeader2:"m#HH:mm", GanttHeaderStyle2:"1", GanttHeader3:"s5#ss",
   ...
   { Name:"minutes and seconds",    GanttUnits:"s", GanttChartRound:"m5", GanttWidth:"10", GanttPrintRound:"m", GanttBackground:"s15#00:00; m#00:00",
                                    GanttHeader1:"m#d1*, '<b>'HH:mm '</b>'*m1", GanttHeader5:"s#ssss'<br>'sssss",
   ...
   { Name:"halves and seconds",     GanttUnits:"s", GanttChartRound:"m5", GanttWidth:"15", GanttPrintRound:"s30", GanttBackground:"s15#00:00; m#00:00",
                                    GanttHeader1:"s30#d1*, '<b>'HH:mm '</b>'*m2", GanttHeader5:"s#ssss'<br>'sssss",
   ...
   { Name:"quarters and seconds",   GanttUnits:"s", GanttChartRound:"m", GanttWidth:"22", GanttPrintRound:"s15", GanttBackground:"s15#00:00; m#00:00",
                                    GanttHeader1:"s15#ddd dddddd MMMM yyyy, '<b>'HH:mm'</b>'*m3", GanttHeader3:"s#ss",
                                    GanttSize:"m2", GanttSizeLeft:"15", GanttSizeRight:"15",
                                    PagerPageSize:"m", PagerChartSize:"m30", PagerFormat:"HH:mm", PagerTipFormat:"M/d HH:mm", PagerCaptionFormat:"dddddd MMM<br>yyyy" },
   ...
   { Name:"seconds and 100 ms",     GanttUnits:"ms100", GanttChartRound:"s2", GanttWidth:"11", GanttPrintRound:"s2", GanttBackground:"s#00:00; m#00:00",
                                    GanttHeader1:"s2#d1*", GanttHeaderStyle1:"2", GanttHeader2:"s#HH:mm:ss", GanttHeaderStyle2:"1", GanttHeader3:"ms100#%f",
   ...
   { Name:"seconds and 100 ms 2",   GanttUnits:"ms100", GanttChartRound:"s", GanttWidth:"75", GanttPrintRound:"s", GanttBackground:"s#00:00; m#00:00",
                                    GanttHeader1:"s#d1*", GanttHeader3:"ms100#HH:mm:ss.'<b>'f'</b>'",
   ...
   { Name:"100 ms and 10 ms 2",     GanttUnits:"ms10", GanttChartRound:"ms100", GanttWidth:"80", GanttPrintRound:"ms100", GanttBackground:"ms100#00:00; s#00:00",
                                    GanttHeader1:"ms100#d1*",  GanttHeader3:"ms10#HH:mm:ss.'<b>'ff'</b>'",
                                    GanttSize:"s", GanttSizeLeft:"10", GanttSizeRight:"10",
                                    PagerPageSize:"s", PagerChartSize:"s30", PagerFormat:"HH:mm:ss", PagerTipFormat:"M/d HH:mm:ss", PagerCaptionFormat:"dddddd MMM<br>yyyy" },
   ...
   { Name:"10 ms and ms 2",         GanttUnits:"ms", GanttChartRound:"ms10", GanttWidth:"100", GanttPrintRound:"ms10", GanttBackground:"ms10#00:00; ms100#00:00",
                                    GanttHeader1:"ms10#d1*", GanttHeader3:"ms#HH:mm:ss.'<b>'fff'</b>'",
                                    GanttSize:"ms100", GanttSizeLeft:"10", GanttSizeRight:"10",
                                    PagerPageSize:"ms100", PagerChartSize:"s2", PagerFormat:"HH:mm:ss.fff", PagerTipFormat:"M/d HH:mm:ss.fff", PagerCaptionFormat:"dddddd MMM<br>yyyy" },
   { Name:"10 ms and ms 3",         GanttUnits:"ms", GanttChartRound:"ms10", GanttWidth:"220", GanttPrintRound:"ms", GanttBackground:"ms10#00:00; ms100#00:00",
                                    GanttHeader1:"ms#d1*", GanttHeaderStyle1:"2", GanttHeader2:"ms#HH:mm:ss.'<b>'fff'</b>'", GanttHeaderStyle2:"1",
...
Pagers: {
   Year: { Caption:"Year", Type:"Gantt", PageSize:"y", ChartSize:"0", Left:"1", Format:"yyyy", Width:"45", ZoomToPage:"5", ZoomUndo:"1" },
   Month: { Caption:"Mon<br>th", MenuName:"Month", Type:"Gantt", PageSize:"M", ChartSize:"y", Left:"1", Format:"MMM", Width:"40", ZoomToPage:"5", ZoomUndo:"1" },
   Pager: { Caption:"Pager", Type:"Gantt", Width:"70", FirstZoom:"halves and hours", ZoomToPage:"4", ChartPrev:"1", ChartNext:"1", ZoomUndo:"1" }
   },
   
// Defines all calendars (excluded dates) available in grid 
Calendars: {
   "Standard": { Exclude:"d#18:00~9:00; d#13:00~14:00#1; w#1/6/2018~1/8/2018#1;" },  // Workdays Monday - Friday, only hours 9:00-13:00 and 14:00-18:00 
   "24 hours": { Exclude:"" },  // 24 hours per day, 7 days per week 
   "Night shift": { Exclude:"d#8:00~23:00; d#3:00~4:00#1; w#1/6/2018 8:00~1/8/2018 8:00#1;" },  // Workdays Monday night - Saturday morning, only hours 23:00-3:00 and 4:00-8:00 
   "Special": { Exclude:"d#18:00~9:00; d#13:00~14:00#1; w#1/6/2018~1/8/2018#1; 3/28/2018~3/29/2018#2" }  // Like Standard, but without 28th March 2018 
   },
...
Solid: [
   ...
   {  Kind:"Group", id:"Group", Space:"0", Panel:"0", Cells:"List,Zoom,Fit,Max,Ex,HidEx,Cal,Bar", CanPrint:"5", NoUpload:"0",
      ...
      FitType:'Button', FitButtonText:'Zoom <b>fit</b>', FitButton:'Button', FitLeft:'2',
      ...
      ExLabel:"<b>Holidays</b>", ExLeft:"2", ExPrintHPage:"2", ExWidth:"50",
   ...
   {  Kind:"Toolbar", id:'Tablet', Space:'1', Visible:'0', Cells:'Right,Objects,All,Main,Main1,Flags,Dependency,Constraints,Bounds,None,Sep,Actions,Every,Move,Resize,New',
      ...
      Objects:'<b>Object:</b>', ObjectsType:'Html', ObjectsCanFocus:'0', ObjectsWrap:'0',
      AllButtonText:'All', AllRadio:'1', AllOnChange:'UpdateActions()', AllMinWidth:'17',
      MainButtonText:'Task', MainRadio:'1', MainOnChange:'UpdateActions()', Main:'1', MainMinWidth:'30',
      Main1ButtonText:'Task 1', Main1Radio:'1', Main1OnChange:'UpdateActions()', Main1MinWidth:'45',
      FlagsButtonText:'Flag', FlagsRadio:'1', FlagsOnChange:'UpdateActions()', FlagsMinWidth:'30',
      DependencyButtonText:'Dependency', DependencyRadio:'1', DependencyOnChange:'UpdateActions()', DependencyMinWidth:'70',
      ConstraintsButtonText:'Constraint', ConstraintsRadio:'1', ConstraintsOnChange:'UpdateActions()', ConstraintsMinWidth:'60',
      BoundsButtonText:'Vertical lines', BoundsRadio:'1', BoundsOnChange:'UpdateActions()', BoundsMinWidth:'75',
      NoneButtonText:'None', NoneRadio:'1', NoneOnChange:'UpdateActions()', NoneMinWidth:'35',
      ...
      EveryButtonText:'All', EveryRadio:'2', Every:'1', EveryOnChange:'UpdateActions()', EveryMinWidth:'17',
      MoveButtonText:'Move', MoveRadio:'2', MoveOnChange:'UpdateActions()', MoveMinWidth:'35',
      ResizeButtonText:'Resize', ResizeRadio:'2', ResizeOnChange:'UpdateActions()', ResizeMinWidth:'45',
      NewButtonText:'Create', NewRadio:'2', NewOnChange:'UpdateActions()', NewMinWidth:'45',
      },
   ...
   {  Kind:"Toolbar1", id:'Controls', Space:'4', Cells:'Resources,Chart,Cols,Single,Win,Empty,Dep', Panel:'0', CanPrint:'5', NoUpload:"0",
      ResourcesLabel:"Display",
      ResourcesType:'SelectGanttResources',
      ResourcesHtmlPrefix:'Tasks with <b>', ResourcesHtmlPostfix:'</b>',
...
Resources: {
   ...
   Management: { Price:"37", Type:"1", Availability:"w#3/6/2018~3/9/2018#1" },
   Development: { Price:"40", Type:"1", Availability:"20;3/26/2018~4/7/2018#-8" },
   Material: { Price:"1", Type:"2", Availability:"15;w#3/20/2018~4/4/2018#20" },
   },
...
Def_2: {
   ...
   Resource: { 
      ...
      ENDDatesRepeatType:"Enum", ENDDatesRepeatEnum:"||Weekly|Daily", ENDDatesRepeatEnumKeys:"||w|d", ENDDatesRepeatWidth:"80",  // Sets the Repeat column of Dates dialog to provide Weekly and Daily repeats 
      ENDDatesValueType:"Float", ENDDatesValueFormat:"0.00", ENDDatesValueCaption:"Count", ENDDatesValueWidth:"70",  // Sets the Value column of Dates dialog to number as count of resource units 
      ENDDatesStartDefaultDate:"3/1/2018", ENDDatesEndDefaultDate:"3/1/2018",  //Default dates for Start and End columns in Dates dialog
...
// Column captions for resources 
   {  Kind:"Header", id:'Resource', idTip:'Resource name. By this name is the resource assigned to the individual tasks',
      ...
      GANTT:' Resources usage', GANTTTip:'Resource usage chart<br>Click to zoom in, right click to zoom out<br>Control the displayed charts in bottom combo "Show resource charts"',
...
Media: [
   ...
   { Size:"Low",
      ...
      Rows: [
         { id:"Group", BarOnChange:'Grid.Cols.GANTT.GanttHeight = Value ? 6 : ""; Grid.Cols.GANTT.GanttTop1 = Value ? 15 : 9; Grid.RefreshGantt();' }
         ]
      },
   { Size:"Small",
      Cols: [
   ...
   { Size:"Wide,High,Big",
      Def: {
         Diagram: { GANTTGanttRunHeight:"108" },  // Height of all the run boxes in pixels
         DiagramTask: { GANTTGanttRunHeight:"108" }
         }
      },
   { Size:"Giant",
      Def: {
         Diagram: { GANTTGanttRunHeight:"128" },  // Height of all the run boxes in pixels
         DiagramTask: { GANTTGanttRunHeight:"128" }
         }
      },
...
// Informational text in the topbar
Lang_2: {
   Text: {
      Gantt: "Mouse in chart: <i>left button drag</i> = move, resize or create bar or move flag or milestone, <i>right button drag</i> = create dependency from bar or milestone or scroll grid,<br/><span style='visibility:hidden;'>Mouse in chart: </span><i>double click</i> = change bar resources or flag or create new milestone or flag,<i>right click</i> = show menu, <i>ctrl + left click</i> = delete bar, item, dependency<br/>Mouse in header: <i>left button drag</i> = zoom in to date range, <i>left click</i> = zoom in to date, <i>right click</i> = zoom back",
      Run:   "Mouse in chart: <i>left button drag</i> = move, resize or create bar, <i>right button drag</i> = create dependency from bar or scroll grid,<br/><span style='visibility:hidden;'>Mouse in chart: </span><i>shift + left button drag</i> = select range of bars, <i>double click</i> = select bar, <i>right click</i> = show menu, <i>ctrl + left click</i> = delete bar<br/>Mouse in header: <i>left button drag</i> = zoom in to date range, <i>left click</i> = zoom in to date, <i>right click</i> = zoom back",
      GanttT:"Controls: <i>drag</i> = scroll grid, <i>tap</i> = focus bar, milestone, flag or the whole cell, <i>drag focused object in row</i> = move or resize bar or move flag or milestone,<br/><span style='visibility:hidden;'>Controls: </span><i>drag focused bar outside row</i> = create dependency from bar, <i>drag empty space in focused cell</i> = create new bar, <i>tap focused object</i> = show menu<br/><span style='visibility:hidden;'>Controls: </span><i>tap header</i> = show zoom menu, <i>pinch zoom in header</i> = zoom in / out. <span style='padding-left:40px;font-style:italic;'>For more precise control choose <i>Object</i> and <i>Action</i> on middle toolbar</span>",
      RunT:  ""
      }
   }
