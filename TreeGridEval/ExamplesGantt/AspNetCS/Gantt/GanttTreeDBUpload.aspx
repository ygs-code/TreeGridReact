...
try
{
   ...
   if (XML != "" && XML != null)
   {
      ...
      if (Ch.Count > 0) foreach (System.Xml.XmlElement I in Ch[0])
      {
         ...
         if (I.GetAttribute("Deleted") == "1" || I.GetAttribute("ToDelete") == "1") SQL = "DELETE FROM GanttTree WHERE id=" + id;
         ...
         else if (I.GetAttribute("Changed") == "1" || I.GetAttribute("Moved") == "2")
         {
            ...
            for(int idx=0;idx<I.Attributes.Count;idx++)
            {
               ...
               { 
                  ...
                  else if (name == "S" || name == "E" || name == "D" || name == "L") SQL += name + " = '" + val + "',";
               }
            }
